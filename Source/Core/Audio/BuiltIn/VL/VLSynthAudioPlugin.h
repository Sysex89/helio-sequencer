...
class VLSynthAudioPlugin final : public BuiltInMicrotonalPlugin
{
public:
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(VLSynthAudioPlugin)
    JUCE_DECLARE_WEAK_REFERENCEABLE(VLSynthAudioPlugin)
};
